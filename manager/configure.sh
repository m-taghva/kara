...
cp -r "$source_dir"/*.conf "$destination_dir"/
...
pip install pytz jdatetime datetime matplotlib pandas alive_progress BeautifulSoup4 wikitextparser mwparserfromhell
if [ $? -eq 0 ]; then
